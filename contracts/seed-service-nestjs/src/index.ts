...
// This file (./service-navigational-list.types.ts) is generated by `npm run gen` during CI or when you run it locally.
/* eslint-disable @typescript-eslint/ban-ts-comment */
// @ts-ignore - file is generated at build/publish time.
export * from './service-navigational-list.types';
